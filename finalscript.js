...
function writePassword() {
  ...
  var passwordLength = window.prompt(
    "Please enter the length of the password 8 -128"
  );
  ...
  var checkCount =
    lowerCaseStringBoolean +
    upperCaseStringBoolean +
    numericBoolean +
    specialCharacterBoolean;
  ...
  if (lowerCaseStringBoolean == true) {
    passwordlist = passwordlist.concat(lCharsString);
  }
  console.log(passwordlist);
  if (upperCaseStringBoolean == true) {
    passwordlist = passwordlist.concat(uCharsString);
  }
  console.log(passwordlist);
  if (specialCharacterBoolean == true) {
    passwordlist = passwordlist.concat(sCharsString);
  }
  console.log(passwordlist);
  if (numericBoolean == true) {
    passwordlist = passwordlist.concat(nChars);
  }
  console.log(passwordlist);
